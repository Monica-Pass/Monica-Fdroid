...
- 基础冲突检测元数据
- snapshot 或等效恢复检查点
- 通过可选 Adapter 提供有界 KDBX3/KDBX4 二进制导入
- 通过可选 Adapter 提供 KDBX4 二进制导出和无覆盖发布
...
- 重写过程中未知字段被保留
- 真实加密 KDBX4 导出导入回环保留字段、分组和附件
- KDBX3/KDBX4 错误密码、畸形输入、KDF 超限和解码资源超限均在修改 MDBX 前失败
- 已有 KDBX 导出目标保持原内容
- 在支持的前提下，附件名称和字节可在导入导出中保留
