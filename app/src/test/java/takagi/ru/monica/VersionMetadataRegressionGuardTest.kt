...
class VersionMetadataRegressionGuardTest {
    ...
    fun `fdroid version metadata remains static and reproducible`() {
        ...
        assertTrue(buildScript.contains("versionCode 20"))
        assertTrue(buildScript.contains("versionName \"1.0.313\""))
        assertTrue(buildScript.contains("'BASE_VERSION_NAME', '\"1.0.313\"'"))
        assertTrue(buildScript.contains("'FULL_VERSION_NAME', '\"1.0.313\"'"))
